      ...
      <div class="pricing-grid">
        <div class="pricing-card">
          ...
          <ul class="features-list">
            ...
            <li><i class="fas fa-check"></i> 2 times breathre animation</li>
        ...
        <div class="pricing-card highlighted">
          ...
          <ul class="features-list">
            ...
            <li class="disabled"><i class="fas fa-times"></i> Select multiple persona and topic</li>
          </ul>
        ...
        <div class="pricing-card">
          ...
          <ul class="features-list">
            ...
            <li><i class="fas fa-check"></i> Select multiple persona and topic</li>
